...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?>">
  ...
  <!-- </div> -->
    ...
    <?php if (!empty($page['search_directory'])): ?>
      <section class="search-directory">
        <?php print render($page['search_directory']); ?>
      </section>
    <?php endif; ?>

    <?php if (!empty($page['hero_banner'])): ?>
...
<div class="main-container <?php print $container_class; ?>" >
  ...
  <div class="row" ng-app="CaseDirectory">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <!-- Angular Search Results -->
      <div class="row">
      <div id="searchResults" ng-controller="SearchResults" ng-init="showMe()" class="col-lg-12 col-md-12 col-xs-12">

      <div id="layout-ctrls" class="col-lg-9 col-md-7 col-xs-12" style="float: none;">
        ...
        <pagination boundary-links="true" total-items="resultsCount" max-size="4" items-per-page="12" ng-model="currentPage" class="pagination-sm" previous-text="&lsaquo;" next-text="&rsaquo;" first-text="&laquo;" last-text="&raquo;"></pagination>
      </div>

      <span style="display:none;" class="results-statistics">Showing {{ resultsCount }} results of {{ total }}...</span>
        <div class="row row-flex row-flex-wrap" ng-repeat="resultRow in pagedResults">
          ...
          <h3 ng-show="resultsCount == 0" class="no-results" ng-bind="(error.results)"></h3>
      </div>
      </div>
  </section>
...
<?php if (!empty($page['post_content'])): ?>
  <section class="post-content <?php print $container_class; ?>">
    <?php print render($page['post_content']); ?>
  </section>
<?php endif; ?>

<?php if (!empty($page['pre_footer1'])): ?>
  <section class="pre-footer1 <?php print $container_class; ?>">
    <?php print render($page['pre_footer1']); ?>
  </section>
<?php endif; ?>

<?php if (!empty($page['pre_footer2'])): ?>
  <section class="pre-footer2 <?php print $container_class; ?>">
    <?php print render($page['pre_footer2']); ?>
  </section>
<?php endif; ?>

<?php if (!empty($page['pre_footer3'])): ?>
  <section class="pre-footer3 <?php print $container_class; ?>">
    <?php print render($page['pre_footer3']); ?>
  </section>
<?php endif; ?>
